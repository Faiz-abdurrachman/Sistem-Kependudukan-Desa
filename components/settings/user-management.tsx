                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          {editingRole === userRole.id ? (
                            <>
                              ...
                              >
                                <SelectTrigger className="w-28 sm:w-32 bg-gray-50">
                              ...
                              <Button
                                ...
                                className="bg-blue-600 hover:bg-blue-500 text-white font-semibold shadow-md border-2 border-blue-500 hover:border-blue-400 text-xs sm:text-sm"
                              >
                                Simpan
                              </Button>
                              <Button
